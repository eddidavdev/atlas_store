...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference("Discount.count") do
      post discounts_url, params: { discount: { expiration_date: @discount.expiration_date, name: @discount.name, percent: @discount.percent } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { expiration_date: @discount.expiration_date, name: @discount.name, percent: @discount.percent } }
